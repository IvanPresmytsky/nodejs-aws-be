...
export const messagesBuilder = {
  createProduct: {
    ...
    success: (product: any) => `The folowing product successully created: ${JSON.stringify(product, null, 2)}`,
  },
  getAllProducts: {
  ...
  getProductById: {
    ...
    success: (product: any) => `Succesfully returned the following product: ${JSON.stringify(product, null, 2)}`,
  },
